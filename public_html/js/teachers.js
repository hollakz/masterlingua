...
for (const videoPopupButton of videoPopupButtons) {
  videoPopupButton.onclick = function () {
    ...
    if (elemId === 'OlgaOconnor') {
      ...
      videoWrapper.insertAdjacentHTML('afterbegin', '<iframe src="https://www.youtube.com/embed/ebES9e9kPsM?modestbranding=1&controls=2&rel=0&playsinline=1" frameborder="0" allowfullscreen></iframe>');
      if (body.classList.contains('rus-lang')) {
      ...
      videoWrapper.insertAdjacentHTML('afterbegin', '<iframe src="https://www.youtube.com/embed/AcT3pEMaVdE?modestbranding=1&controls=2&rel=0&playsinline=1" frameborder="0" allowfullscreen></iframe>');
      if (body.classList.contains('rus-lang')) {
      ...
      videoWrapper.insertAdjacentHTML('afterbegin', '<iframe src="https://www.youtube.com/embed/Oiu1x_jvPLw?modestbranding=1&controls=2&rel=0&playsinline=1" frameborder="0" allowfullscreen></iframe>');
      if (body.classList.contains('rus-lang')) {
    ...
    } else if (elemId === 'NadolskayaEkaterina') {
